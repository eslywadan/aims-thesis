...
public class SchedOpenShop {
 ...
 public static void launcher(String[] args) throws IOException {
	 // /cp_scheduling/data/openshop/gp10-4.data
     String filename = "./data/openshop/tai20-6.data";
	// "C:/Program Files/IBM/ILOG/CPLEX_Studio128/cpoptimizer/examples/data/openshop_default.data";
     ...
     try {
         ...
         cp.setParameter(IloCP.DoubleParam.TimeLimit, 1200.0);
